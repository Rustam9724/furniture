...
function SignInSection() {
    ...
    const [isPaswordValid, setIsPasswordValid] = useState(true);
    const [isPasswordHidden, setIsPasswordHidden] = useState(true);

    const passwordEyeStyle = {
        minWidth: '25px',
        aspectRatio: '25/23',
        backgroundImage: isPasswordHidden ? 'url("./assets/images/eye-on.svg")' : 'url("./assets/images/eye-off.svg")',
        cursor: 'pointer',
    ...
    return (
        <section className="sign-section">
            <div className="sign-section__container _container">
                <Link className="sign-section__header" to="/">
